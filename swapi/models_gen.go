...
type BrowseQuery struct {
	...
	Films     FilmConnection     `json:"films"`
	Starships StarshipConnection `json:"starships"`
	Vehicles  VehicleConnection  `json:"vehicles"`
	Species   SpecieConnection   `json:"species"`
